<footer>
    <section class="footer-wrapper-two w-full bg-secondary relative">
        <div class="theme-container mx-auto relative">
            <div
                class="discover-area z-20 w-full sm:h-[253px] h-[300px] rounded-[10px] left-0 absolute -top-[125px] lg:px-[60px] p-5 sm:px-[42px] flex sm:flex-row flex-col space-y-14 sm:space-y-0 sm:justify-between sm:items-center">
                <div>
                    <p class="text-base leading-7 text-white mb-1">
                        For your car we will do everything
                    </p>
                    <h2 class="headline-default text-white">
                        Let's get your insurance & <br class="sm:block hidden" />
                        lead a secure life
                    </h2>
                </div>
                <div>
                    <a href="#">
                        <div
                            class="lg:px-10 hover:border-transparent inline lg:py-6 px-8 py-5 border border-white hover:bg-white common-trans rounded-lg text-lg font-semibold leading-4 spline-sans text-white hover:text-primary-500">
                            Discover More
                        </div>
                    </a>
                </div>
        ...
        <div class="theme-container mx-auto relative z-10">
            <div class="w-full pt-[210px]">
                <div
                    class="grid lg:grid-cols-4 sm:grid-cols-3 grid-cols-1 gap-[30px] items-center lg:justify-between pb-[60px] mb-10 border-b border-primaryBorder">
                    <!--            logo-->
                    <a href="index-2.html" class="block">
                    ...
                    <div class="flex lg:justify-end">
                        <div class="flex space-x-2.5 items-center">
                            <a href="https://www.facebook.com/"
                                class="transform translate-y-0 hover:-translate-y-1 common-trans">
                                <div style="
                  ...
                  "
                                    ...
                                    <span>
                                        <svg width="12" height="16" viewBox="0 0 12 16" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M6.375 0.21875C3.15625 0.21875 0 2.34375 0 5.8125C0 8 1.21875 9.25 1.96875 9.25C2.28125 9.25 2.46875 8.40625 2.46875 8.15625C2.46875 7.875 1.71875 7.25 1.71875 6.03125C1.71875 3.53125 3.625 1.75 6.09375 1.75C8.25 1.75 9.8125 2.96875 9.8125 5.1875C9.8125 6.84375 9.15625 9.9375 7 9.9375C6.21875 9.9375 5.53125 9.375 5.53125 8.59375C5.53125 7.40625 6.375 6.25 6.375 5.03125C6.375 2.96875 3.4375 3.34375 3.4375 5.84375C3.4375 6.375 3.5 6.9375 3.75 7.4375C3.3125 9.28125 2.4375 12.0625 2.4375 13.9688C2.4375 14.5625 2.5 15.125 2.5625 15.7188C2.65625 15.8438 2.625 15.8438 2.78125 15.7812C4.34375 13.625 4.3125 13.1875 5 10.375C5.40625 11.0938 6.375 11.5 7.1875 11.5C10.5 11.5 12 8.25 12 5.34375C12 2.25 9.3125 0.21875 6.375 0.21875Z"
                                                fill="#028835" />
                                        </svg>
                                    </span>
                                </div>
                ...
                <div
                    class="grid lg:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-[30px] lg:gap-0 pb-[80px] border-b border-primaryBorder">
                    <div class="article">
                        <p class="text-lg font-semibold text-primary-900 spline-sans mb-[30px]">
                            About Us
                        </p>
                        <p class="text-base text-primary-100 leading-[27px]">
                        ...
                        <ul class="flex flex-col space-y-2.5">
                            <li>
                                <a href="service-details.html"
                                    class="text-base text-primary-100 leading-[27px] hover:underline hover:text-gray-900 hover:font-medium">Business
                                    Credit industry</a>
                            </li>
                            <li>
                                <a href="service-details.html"
                                    class="text-base text-primary-100 leading-[27px] hover:underline hover:text-gray-900 hover:font-medium">Finance
                                    industry</a>
                            </li>
                            <li>
                                <a href="service-details.html"
                                    class="text-base text-primary-100 leading-[27px] hover:underline hover:text-gray-900 hover:font-medium">Software
                                    development</a>
                            </li>
                        </ul>
                    </div>
                    <div class="colum-2">
                        ...
                        <ul class="flex flex-col space-y-2.5">
                            <li>
                                <a href="project.html"
                                    class="text-base text-primary-100 leading-[27px] hover:underline hover:text-gray-900 hover:font-medium flex space-x-2.5 items-center">
                                    <span><svg width="13" height="11" viewBox="0 0 13 11" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                ...
                <div class="w-full h-[90px] flex justify-between items-center">
                    ...
                    <ul class="lg:flex hidden space-x-[30px] items-center">
                        <li>
                            <a href="#" class="text-base leading-[27px] text-primary-900 hover:underline">Terms
                                &
                                Condition</a>
                        </li>
                        <li>
                            <a href="#"
                                class="text-base leading-[27px] text-primary-900 hover:underline">Privacy
                                Policy</a>
                        </li>
                        <li>
                            <a href="#"
                                class="text-base leading-[27px] text-primary-900 hover:underline">Contact Us</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="absolute top-[250px] right-0">
            <img src="{{ asset('assets/img/footer-two-shape.png') }}" alt="" />
        </div>
    </section>
</footer>
<!-- video popup   -->
<div class="popv-main-wrapper">
    <div class="popv-bg popv-ready" onclick="videoPopup()"></div>
    <div class="popv-wrap popv-close-btn-in popv-auto-cursor popv-ready" tabindex="-1" style="overflow: hidden">
        <div class="popv-container popv-s-ready popv-iframe-holder">
            <div class="popv-content">
                <div class="popv-iframe-scaler">
                    <button onclick="videoPopup()" title="Close (Esc)" type="button" class="popv-close">
                        ×
                    </button>
                    <iframe title="video" class="popv-iframe" src="https://www.youtube.com/embed/3ctoSEQsY54"
